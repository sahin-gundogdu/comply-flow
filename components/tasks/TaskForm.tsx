      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <Input placeholder="Görev başlığı" {...field} readOnly={readOnly} />
                </FormControl>
                <FormMessage />
                </FormItem>
            )}
            ...
            {fields.map((field, index) => (
                <div key={field.id} className="flex items-end gap-2">
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Alt görev başlığı" {...field} readOnly={readOnly} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Atanan" {...field} readOnly={readOnly} />
                        </FormControl>
                        </FormItem>
                    )}
                    />
            ...
            <div className="flex items-center justify-center w-full">
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-700 border-gray-300 dark:border-gray-600">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400"><span className="font-semibold">Yüklemek için tıklayın</span> veya sürükleyip bırakın</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400">PDF, DOCX, JPG (MAKS. 25MB)</p>
                    </div>
        ...
        <div className="flex justify-end gap-2">
            ...
            {!readOnly && <Button type="submit">Görev Oluştur</Button>}
        </div>
      </form>
    </Form>
  );
